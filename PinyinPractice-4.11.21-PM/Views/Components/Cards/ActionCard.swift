            ...
            VStack(alignment: .leading, spacing: 12) {
                HStack {
                    Image(systemName: icon)
                        ...
                        .foregroundColor(isDisabled ? .secondaryText : color)
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text(title)
                        ...
                        .foregroundColor(isDisabled ? .secondaryText : .primaryText)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 20)
                            .stroke(
                                LinearGradient(
                                    colors: [
                                        isDisabled ? Color.lightSilver.opacity(0.2) : color.opacity(0.3),
                                        Color.clear
                                    ],
